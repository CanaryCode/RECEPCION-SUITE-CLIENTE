...
cd /d "%~dp0"
echo ===================================================
echo   COMPILADOR DE AGENTE - RECEPCION SUITE
echo ===================================================
echo.
...
:: 2. Definir rutas
set "SOURCE=AgentLauncher.cs"
set "OUTPUT=RecepcionAgent.exe"
:: Usar icono si existe en la ruta esperada (ajustar si es necesario)
